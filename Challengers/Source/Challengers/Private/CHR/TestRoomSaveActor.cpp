...
#include "CHR/TestRoomSaveActor.h"
...
// Sets default values
ATestRoomSaveActor::ATestRoomSaveActor()
{
	...
	boxComp->OnComponentBeginOverlap.AddDynamic(this, &ATestRoomSaveActor::OnOverlapBegin);
	boxComp->OnComponentEndOverlap.AddDynamic(this, &ATestRoomSaveActor::OnOverlapEnd);
...
void ATestRoomSaveActor::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void ATestRoomSaveActor::OnOverlapEnd(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	AChallengersCharacter* Player = Cast<AChallengersCharacter>(OtherActor);
	AMainPlayerController* PlayerController = Cast<AMainPlayerController >(UGameplayStatics::GetPlayerController(GetWorld(), 0));
