...
#include "CHR/TestRoomLoadActor.h"
...
// Sets default values
ATestRoomLoadActor::ATestRoomLoadActor()
{
	...
	boxComp->OnComponentBeginOverlap.AddDynamic(this, &ATestRoomLoadActor::OnOverlapBegin);
	boxComp->OnComponentEndOverlap.AddDynamic(this, &ATestRoomLoadActor::OnOverlapEnd);
}
...
void ATestRoomLoadActor::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void ATestRoomLoadActor::OnOverlapEnd(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	AChallengersCharacter* Player = Cast<AChallengersCharacter>(OtherActor);
	AMainPlayerController* PlayerController = Cast<AMainPlayerController >(UGameplayStatics::GetPlayerController(GetWorld(), 0));
